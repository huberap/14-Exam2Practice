...
def run_test_practice_problem2a():
    ...
    print('actual: ',practice_problem2a([0,1,2],1))

    print('Test 2')
    print('expected: [-9,1]')
    print('actual: ', practice_problem2a([-10,0],1))

    print('Test 3')
    print('expected: [10,11,12]')
    print('actual: ', practice_problem2a([0,1,2],10))

    print('Test 4')
    print('expected: [2,2,2]')
    print('actual: ', practice_problem2a([2,2,2],0))
